...
//				mGridLayout.removeView(button);
    ...
    private void runAnimation(View inView) {
        ObjectAnimator mAnimator_RotateY = ObjectAnimator
                .ofFloat(inView, "rotationY", 0.0F, 360.0F);
        mAnimator_RotateY
                .setDuration(200);
        ObjectAnimator mAnimator_ScaleX = ObjectAnimator.ofFloat(inView, "scaleX",
                1.0f, 1.3f);
        mAnimator_ScaleX
                .setDuration(100);
        ObjectAnimator mAnimator_ScaleX_Reverse = ObjectAnimator.ofFloat(inView, "scaleX",
                1.3f, 1.0f);
        mAnimator_ScaleX_Reverse
                .setDuration(100);
        ObjectAnimator mAnimator_ScaleY = ObjectAnimator.ofFloat(inView, "scaleY",
                1.0f, 1.3f);
        mAnimator_ScaleY
                .setDuration(100);
        ObjectAnimator mAnimator_ScaleY_Reverse = ObjectAnimator.ofFloat(inView, "scaleY",
                1.3f, 1.0f);
        mAnimator_ScaleY_Reverse
                .setDuration(100);
